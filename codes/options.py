...
def get_options(args=None):
    ...
    parser.add_argument('--attack_type', type=str, default='filtering-attack', choices = ['random-action', 'sign-flipping', 'nosing-reward', 'reward-flipping', 'variance-attack', 'random-noise', 'filtering-attack', 'filtering-attack-7', 'filtering-attack-5'], help = 'the attack type of a Byzantine worker')
